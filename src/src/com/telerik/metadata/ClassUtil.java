...
class ClassUtil {
	...
	public static boolean isPrimitive(Type type) {
		boolean isPrimitive = type.equals(Type.BOOLEAN) || type.equals(Type.CHAR)
				|| type.equals(Type.BYTE) || type.equals(Type.SHORT) || type.equals(Type.INT) || type.equals(Type.LONG)
	...
	public static boolean isPrimitive(String name) {
		boolean isPrimitive = name.equals("C") || name.equals("Z")
				|| name.equals("B") || name.equals("S") || name.equals("I") || name.equals("J")
	...
	public static String getCanonicalName(String className) {
		...
		if (className.startsWith("L") && className.endsWith(";")) {
			canonicalName = className.substring(1, className.length()-1).replace('/', '.');
		} else {
